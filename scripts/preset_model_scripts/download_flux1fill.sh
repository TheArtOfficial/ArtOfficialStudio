...
# Model-URL: https://huggingface.co/black-forest-labs/FLUX.1-Fill-dev
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "flux1-fill-dev.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
