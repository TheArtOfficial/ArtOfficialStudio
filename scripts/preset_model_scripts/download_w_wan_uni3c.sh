#!/bin/bash
# Model: Uni3C Wan ControlNet
# Requires-HF-Token: false
# Model-URL: https://ewrfcas.github.io/Uni3C/
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "wan2.1_i2v_480p_14B_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/loras \
    -o 360_lora.safetensors --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
# Download Wan21_Uni3C_controlnet_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/controlnet" \
    -o "Wan21_Uni3C_controlnet_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
