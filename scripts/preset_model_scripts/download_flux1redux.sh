...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "flux1-redux-dev.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "t5xxl_fp8_e4m3fn.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/vae" \
    -o "flux_vae.safetensors" --auto-file-renaming=false --conditional-get=true \
