#!/bin/bash
# Model: Common Controlnets (SD15, SDXL, Flux)
# Requires-HF-Token: false
# Model-URL: https://github.com/lllyasviel/ControlNet

# Create output directory if it doesn't exist
mkdir -p "/workspace/ComfyUI/models/controlnet"

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11p_sd15_canny_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11p_sd15_canny_fp16.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11f1p_sd15_depth_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11f1p_sd15_depth_fp16.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11p_sd15_inpaint_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11p_sd15_inpaint_fp16.safetensors


aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11p_sd15_lineart_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11p_sd15_openpose_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o control_v11u_sd15_tile_fp16.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
# ControlNet SDXL
aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o diffusers_xl_canny_full.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/diffusers_xl_canny_full.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o t2i-adapter_diffusers_xl_depth_midas.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/t2i-adapter_diffusers_xl_depth_midas.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o sai_xl_depth_256lora.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/sai_xl_depth_256lora.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o diffusers_xl_depth_small.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    https://huggingface.co/lllyasviel/sd_control_collection/resolve/main/diffusers_xl_depth_small.safetensors

aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o tile_sdxl.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -c -x 16 -s 16  -d /workspace/ComfyUI/models/controlnet \
    -o flux_union_pro_2.0.safetensors  --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
