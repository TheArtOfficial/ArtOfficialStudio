...
# Model-URL: https://github.com/SkyworkAI/SkyReels-V2
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-I2V-14B-540P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-T2V-14B-540P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/Skyreels/Wan2_1-SkyReels-V2-T2V-14B-540P_fp16.safetensors"

# Download Skyreels/Wan2_1-SkyReels-V2-DF-1_3B-540P_fp32.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
