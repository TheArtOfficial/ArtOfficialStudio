...
# Model-URL: https://huggingface.co/black-forest-labs/FLUX.1-Krea-dev

echo "Downloading files from HuggingFace repository black-forest-labs/FLUX.1-Krea-dev..."

# Create output directory if it doesn't exist
mkdir -p "/workspace/ComfyUI/models"

# Download flux1-krea-dev.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "flux1-krea-dev.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
