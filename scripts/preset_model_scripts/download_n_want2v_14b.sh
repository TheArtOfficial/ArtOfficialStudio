...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "wan2.1_t2v_1.3B_fp16.safetensors" --auto-file-renaming=false --conditional-get=true \
    "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_t2v_1.3B_fp16.safetensors"

# Download split_files/diffusion_models/wan2.1_t2v_14B_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "wan2.1_t2v_14B_fp16.safetensors" --auto-file-renaming=false --conditional-get=true \
