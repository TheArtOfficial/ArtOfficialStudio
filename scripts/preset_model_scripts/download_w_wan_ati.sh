#!/bin/bash
# Model: ATI: Any Trajectory Instruction
# Requires-HF-Token: false
# Model-URL: https://anytraj.github.io/
...
# Download Wan2_1-I2V-ATI-14B_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-I2V-ATI-14B_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
