...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "FramePackI2V_HY_bf16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/clip_vision" \
    -o "sigclip_vision_patch14_384.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
