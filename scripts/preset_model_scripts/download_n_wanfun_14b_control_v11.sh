...
# Model-URL: https://huggingface.co/alibaba-pai/Wan2.1-Fun-V1.1-14B-Control
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "wan2.1_fun_control_v11_14B.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    "https://huggingface.co/alibaba-pai/Wan2.1-Fun-V1.1-14B-Control/resolve/main/diffusion_pytorch_model.safetensors"

echo "All downloads completed!"# Download split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors
