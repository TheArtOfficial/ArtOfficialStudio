...
# Model-URL: https://huggingface.co/HiDream-ai/HiDream-I1-Fast
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "hidream_clip_g.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "hidream_clip_l.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
# Download split_files/diffusion_models/hidream_i1_dev_bf16.# Download split_files/diffusion_models/hidream_i1_fast_bf16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "hidream_i1_fast_bf16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
