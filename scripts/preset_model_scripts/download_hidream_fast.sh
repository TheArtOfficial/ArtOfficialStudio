...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "clip_g_hidream.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "clip_l_hidream.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/vae" \
    -o "ae.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "llama_3.1_8b_instruct_fp8_scaled.safetensors" --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/text_encoders" \
    -o "t5xxl_fp8_e4m3fn_scaled.safetensors" --auto-file-renaming=false --conditional-get=true \
...
# Download split_files/diffusion_models/hidream_i1_fast_bf16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "hidream_i1_fast_bf16.safetensors" --auto-file-renaming=false --conditional-get=true \
