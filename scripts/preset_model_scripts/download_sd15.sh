...
# Model-URL: https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/checkpoints" \
    -o "v1-5-pruned.ckpt" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
