#!/bin/bash
# Model: Wan UniAnimate
# Requires-HF-Token: false
# Model-URL: https://github.com/ali-vilab/UniAnimate-DiT
...
# Download UniAnimate-Wan2.1-14B-Lora-12000-fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/loras" \
    -o "UniAnimate-Wan2.1-14B-Lora-12000-fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
