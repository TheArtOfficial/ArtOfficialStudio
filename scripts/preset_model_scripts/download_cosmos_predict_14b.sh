#!/bin/bash
# Model: Cosmos Predict 2 14B Video2World
...
# Download cosmos_predict2_14B_video2world_480p_16fps.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "cosmos_predict2_14B_video2world_480p_16fps.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    "https://huggingface.co/Comfy-Org/Cosmos_Predict2_repackaged/resolve/main/cosmos_predict2_14B_video2world_480p_16fps.safetensors"

# Download cosmos_predict2_14B_video2world_720p_16fps.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "cosmos_predict2_14B_video2world_720p_16fps.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
    "https://huggingface.co/Comfy-Org/Cosmos_Predict2_repackaged/resolve/main/cosmos_predict2_14B_video2world_720p_16fps.safetensors"
