...
# Model-URL: https://github.com/Tencent/HunyuanVideo-I2V
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/diffusion_models \
    -o hunyuan_video_image_to_video_720p_bf16.safetensors --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/diffusion_models \
    -o hunyuan_video_v2_replace_image_to_video_720p_bf16.safetensors --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
