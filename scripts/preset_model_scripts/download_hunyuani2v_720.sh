...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/clip_vision \
    -o llava_llama3_vision.safetensors --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/diffusion_models \
    -o hunyuan_video_image_to_video_720p_bf16.safetensors --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/diffusion_models \
    -o hunyuan_video_v2_replace_image_to_video_720p_bf16.safetensors --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/vae \
    -o hunyuan_video_vae_bf16.safetensors --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/text_encoders \
    -o llava_llama3_fp8_scaled.safetensors --auto-file-renaming=false --conditional-get=true \
...
aria2c -x 16 -s 16 -d /workspace/ComfyUI/models/text_encoders \
    -o clip_l.safetensors --auto-file-renaming=false --conditional-get=true \
