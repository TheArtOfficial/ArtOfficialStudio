...
# Download Skyreels/Wan2_1-SkyReels-V2-DF-14B-720P_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-DF-14B-720P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true \
    "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/Skyreels/Wan2_1-SkyReels-V2-DF-14B-720P_fp16.safetensors"

# Download Skyreels/Wan2_1-SkyReels-V2-I2V-14B-720P_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-I2V-14B-720P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true \
    "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/Skyreels/Wan2_1-SkyReels-V2-I2V-14B-720P_fp16.safetensors"

# Download Skyreels/Wan2_1-SkyReels-V2-T2V-14B-720P_fp16.safetensors
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-T2V-14B-720P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true \
