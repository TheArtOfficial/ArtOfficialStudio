#!/bin/bash
# Model: Skyreels V2 720p & Diff Extension
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-DF-14B-720P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
...
aria2c -x 16 -s 16 -d "/workspace/ComfyUI/models/diffusion_models" \
    -o "Wan2_1-SkyReels-V2-I2V-14B-720P_fp16.safetensors" --auto-file-renaming=false --conditional-get=true --allow-overwrite=true \
